 ...
 *
 * @param {string} hexValue - The hexadecimal color value to look up.
 * @returns {string|null} A color name string, or null when there is no match.
 */
 ...
 * class list.
 *
 * @param {HTMLElement} element - The element whose color modifier classes will be removed.
 * @returns {void}
 */
